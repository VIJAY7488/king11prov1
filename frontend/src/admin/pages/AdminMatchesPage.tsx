...
export default function AdminMatchesPage() {
  ...
  const [form, setForm] = useState({ league: "", matchNumber: "", team1Name: "", team2Name: "", matchDate: "", venue: "" });
  ...
  function resetFormState() {
    setForm({ league: "", matchNumber: "", team1Name: "", team2Name: "", matchDate: "", venue: "" });
    setTeam1Players([]);
    setTeam2Players([]);
    setEditingId(null);
  }
      ...
      {showForm && (
        <div style={{ background: "#141414", border: "1px solid #2A2A2A", borderRadius: 12, padding: 24, marginBottom: 24 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14, marginBottom: 16 }}>
            ...
            <Field label="Match Number" value={form.matchNumber} onChange={(v) => setF("matchNumber", v)} placeholder="Match 12 / #12" />
          ...
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            <thead>
              <tr style={{ borderBottom: "1px solid #1E1E1E" }}>
                {["League", "Match #", "Match", "Date", "Venue", "Status", "ID", "Actions"].map((h) => (
